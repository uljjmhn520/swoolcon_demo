...
namespace PhalconPlus\Session;

use App\Common\Library\Providers\RandomServiceProvider;
 ...
 */
abstract class SwooleAdapter implements AdapterInterface, InjectionAwareInterface
//abstract class SwooleAdapter implements AdapterInterface
{
    ...
    private function checkRequireService()
    {
        ...
        if (!$cookies || !($cookies instanceof SwooleCookies)) {
            throw new Exception('The "' . SwooleCookies::class . '" is not in the dependency injection object');
        }
