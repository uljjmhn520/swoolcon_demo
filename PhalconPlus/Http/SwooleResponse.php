...
use PhalconPlus\Http\Response\SwooleHeaders;
 ...
 */
class SwooleResponse extends Response implements ResponseInterface , InjectionAwareInterface{
    ...
    public function __construct($content = null, $code = null, $status = null) {
        ...
        $this->_headers = new SwooleHeaders();
    ...
    public function setDI(DiInterface $dependencyInjector) {
        ...
        if (!$this->_swooleRequest) {
            throw new Response\Exception('swoole request is empty',2314131);
        }
        if (!$this->_swooleResponse) {
            throw new Response\Exception('swoole response is empty',2314131);
        }

        if($this->_headers){
            $this->_headers->setDI($dependencyInjector);
        }

    }

    /**
     * @param Response\HeadersInterface|InjectionAwareInterface $headers
     * @return $this
     */
    ...
    public function setStatusCode($code, $message = null) {
        ...
        if($message === null){
            ...
            if(!isset($statusCodes[$code])){
                throw new Response\Exception('Non-standard statuscode given without a message');
            }
